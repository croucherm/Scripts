...
declare -r -A apps=(
    ...
    # monitoring ["Adobe Acrobat Reader"]="https://get.adobe.com/reader/direct/"
    # monitoring ["Adobe Acrobat Pro"]="https://helpx.adobe.com/acrobat/kb/acrobat-dc-downloads.html"
    ...
    # monitoring ["Docker"]="https://desktop.docker.com/mac/stable/Docker.dmg"
    ["Dropbox"]="https://www.dropbox.com/downloading?type=full"
    # monitoring ["Duet"]="https://updates.duetdisplay.com/latestMac"
    ...
    ["Google Earth Pro"]="https://dl.google.com/earth/client/advanced/current/GoogleEarthProMac-Intel.dmg"
    ...
    # monitoring ["iLok License Manager"]="https://installers.ilok.com/iloklicensemanager/LicenseSupportInstallerMac.zip"
    ...
    # monitoring ["Microsoft Intune Company Portal"]="https://go.microsoft.com/fwlink/?linkid=869655"
    ...
    # monitoring ["OnyX"]="https://www.titanium-software.fr/download/26/OnyX.dmg"
    ...
    # monitoring ["DaVinci Resolve"]="https://www.blackmagicdesign.com/products/davinciresolve/"
    ...
    # monitoring ["IntelliJ IDEA"]="https://www.jetbrains.com/idea/download/#section=mac"
